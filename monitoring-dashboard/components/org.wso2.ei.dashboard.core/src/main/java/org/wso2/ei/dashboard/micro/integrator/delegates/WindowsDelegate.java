...
public class WindowsDelegate implements ArtifactDelegate {
    ...
    private static final Logger logger = LogManager.getLogger(WindowsDelegate.class);
    ...
    public Ack updateArtifact(String groupId, ArtifactUpdateRequest request) throws ManagementApiException {
        logger.debug("Updating Window " + request.getArtifactName() + " in node " + request.getNodeId() +
                " in group " + groupId);
