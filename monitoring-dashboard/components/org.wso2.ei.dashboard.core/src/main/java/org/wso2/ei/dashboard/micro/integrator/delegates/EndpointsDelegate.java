...
public class EndpointsDelegate implements ArtifactDelegate {
    private static final Log log = LogFactory.getLog(EndpointsDelegate.class);
    private final DatabaseManager databaseManager = DatabaseManagerFactory.getDbManager();

    @Override
    public Artifacts getArtifactsList(String groupId, List<String> nodeList) {
        log.debug("Fetching Endpoints from database.");
    ...
    public Ack updateArtifact(String groupId, ArtifactUpdateRequest request) {
        log.debug("Updating Endpoint " + request.getArtifactName() + " in node " + request.getNodeId() + " in group "
                  + groupId);
    ...
    private boolean updateEndpoint(String groupId, ArtifactUpdateRequest request) {
