...
export const categories = [
    {
      id: 'General',
      children: [
        { id: 'Proxy Services', to: '/proxy_services', icon: <ProxyIcon /> },
        { id: 'Endpoints', to: '/endpoints', icon: <EndpointIcon /> },
        { id: 'Inbound Endpoints', to: '/inbound_endpoints', icon: <InbountEpIcon /> },
        { id: 'Message Processors', to: '/message_processors', icon: <MessageProcessorIcon /> },
        { id: 'Message Stores', to: '/message_stores', icon: <MessageStoreIcon /> },
        ...
        { id: 'Local Entries', to: '/local_entries', icon: <LocalEntriesIcon /> },
        { id: 'Datasources', to: '/data_services', icon: <LayersIcon /> },
        { id: 'Connectors', to: '/connectors', icon: <ConnectorIcon /> },
        { id: 'Carbon Applications', to: '/carbon_applications', icon: <CappIcon /> },
        { id: 'Log Files', to: '/log_files', icon: <LogFileIcon /> },
      ],
    },
    {
      id: 'Global Settings',
      children: [
        { id: 'Log Configs', to: 'log_config', icon: <LocalEntriesIcon /> },
