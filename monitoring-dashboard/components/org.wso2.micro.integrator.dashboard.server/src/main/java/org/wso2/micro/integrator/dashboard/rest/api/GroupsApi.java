package org.wso2.micro.integrator.dashboard.rest.api;

import org.wso2.micro.integrator.dashboard.rest.model.ApiList;
import org.wso2.micro.integrator.dashboard.rest.model.ApiUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.CAppList;
import org.wso2.micro.integrator.dashboard.rest.model.ConnectorList;
import org.wso2.micro.integrator.dashboard.rest.model.DataserviceList;
import org.wso2.micro.integrator.dashboard.rest.model.DatasourceList;
import org.wso2.micro.integrator.dashboard.rest.model.EndpointList;
import org.wso2.micro.integrator.dashboard.rest.model.EndpointUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.Error;
import java.io.File;
import org.wso2.micro.integrator.dashboard.rest.model.GroupList;
import org.wso2.micro.integrator.dashboard.rest.model.InboundEpList;
import org.wso2.micro.integrator.dashboard.rest.model.InboundEpUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.LocalEntryList;
import org.wso2.micro.integrator.dashboard.rest.model.LogConfig;
import org.wso2.micro.integrator.dashboard.rest.model.LogConfigAddRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.LogList;
import org.wso2.micro.integrator.dashboard.rest.model.MessageProcessorList;
import org.wso2.micro.integrator.dashboard.rest.model.MessageProcessorUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.MessageStoreList;
import org.wso2.micro.integrator.dashboard.rest.model.NodeList;
import org.wso2.micro.integrator.dashboard.rest.model.ProxyList;
import org.wso2.micro.integrator.dashboard.rest.model.ProxyUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.SequenceList;
import org.wso2.micro.integrator.dashboard.rest.model.SequenceUpdateRequestBody;
import org.wso2.micro.integrator.dashboard.rest.model.SuccessStatus;
import org.wso2.micro.integrator.dashboard.rest.model.TaskList;
import org.wso2.micro.integrator.dashboard.rest.model.TemplateList;
import org.wso2.micro.integrator.dashboard.rest.model.User;
import org.wso2.micro.integrator.dashboard.rest.model.UserAddRequestBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2020-11-27T09:42:44.791+05:30[Asia/Colombo]")
